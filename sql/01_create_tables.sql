-- Rensa gammalt (CASCADE gör att ordningen spelar mindre roll)
...
ALTER TABLE
    school
ADD
    CONSTRAINT check_valid_phone_school CHECK (phone_nr ~ '^[0-9+\- ]+$');
...
ALTER TABLE
    company
ADD
    CONSTRAINT check_valid_email_company CHECK (
...
ALTER TABLE
    consultant_agency
ADD
    CONSTRAINT check_valid_email_agency CHECK (
...
ALTER TABLE
    consultant_agency
ADD
    CONSTRAINT check_valid_phone_agency CHECK (phone_nr ~ '^[0-9+\- ]+$');
...
ALTER TABLE
    education_leader
ADD
    CONSTRAINT check_valid_email_leader CHECK (
        email ~* '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'
    );
...
ALTER TABLE
    education_leader
ADD
    CONSTRAINT check_valid_phone_leader CHECK (phone_nr ~ '^[0-9+\- ]+$');
...
ALTER TABLE
    teacher
ADD
    CONSTRAINT check_valid_email_teacher CHECK (
        email ~* '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'
    );
...
ALTER TABLE
    teacher
ADD
    CONSTRAINT check_valid_phone_teacher CHECK (phone_nr ~ '^[0-9+\- ]+$');
...
ALTER TABLE
    student_info
ADD
    CONSTRAINT check_valid_phone_student CHECK (phone_nr ~ '^[0-9+\- ]+$');

ALTER TABLE
    student_info
ADD
    CONSTRAINT check_valid_email_student CHECK (
        email ~* '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'
    );
...
ALTER TABLE
    employee_info
ADD
    CONSTRAINT check_valid_email_employee CHECK (
        email ~* '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'
    );
...
ALTER TABLE
    employee_info
ADD
    CONSTRAINT check_valid_phone_employee CHECK (phone_nr ~ '^[0-9+\- ]+$');
